...
*/
static double
dpois_wrap (double x_plus_1, double lambda, bool give_log)
{
#ifdef DEBUG_p
 ...
 */
static double
pgamma_smallx (double x, double alph, bool lower_tail, bool log_p)
{
 ...
 */
static double
dpnorm (double x, bool lower_tail, double lp)
{
    /*
 ...
 */
static double
ppois_asymp (double x, double lambda, bool lower_tail, bool log_p)
{
...
double pgamma_raw (double x, double alph, bool lower_tail, bool log_p)
{
...
double pgamma(double x, double alph, double scale, bool lower_tail, bool log_p)
{
#ifdef IEEE_754
