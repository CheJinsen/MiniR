...
double fpser(double a, double b, double x, double eps, bool log_p)
{
	/* ----------------------------------------------------------------------- *
...
static double bpser(double a, double b, double x, double eps, bool log_p)
{
	/* -----------------------------------------------------------------------
...
static double brcomp(double a, double b, double x, double y, bool log_p)
{
	/* -----------------------------------------------------------------------
...
//                        -----
static double brcmp1(int mu, double a, double b, double x, double y, bool give_log)
{
	/* -----------------------------------------------------------------------
...
static double basym(double a, double b, double lambda, double eps, bool log_p)
{
	/* ----------------------------------------------------------------------- */
...
static double esum(int mu, double x, bool give_log)
{
	/* ----------------------------------------------------------------------- */
