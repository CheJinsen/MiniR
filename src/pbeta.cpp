...
double pbeta_raw(double x, double a, double b, bool lower_tail, bool log_p)
{
    ...
    double x1 = 0.5 - x + 0.5, w = 0.0, wc = 0.0;
    int ierr = 0;
...
double pbeta(double x, double a, double b, bool lower_tail, bool log_p)
{
