...
double dwilcox(double x, double m, double n, bool give_log)
{
    double d;
...
double pwilcox(double q, double m, double n, bool lower_tail, bool log_p)
{
    int i;
    double c, p;
...
double qwilcox(double x, double m, double n, bool lower_tail, bool log_p)
{
    double c, p;
